...
{\textbf{\Large{Nghiên cứu và xây dựng hệ thống giao dịch riêng tư trên Ethereum sử dụng Stealth Address và Account Abstraction}}\\[1cm]

{\textbf{\large{NGUYỄN VĂN AN}}}\\
{\large{an.nv224910@sis.hust.edu.vn}}\\[0.5cm]
...
\resizebox{\textwidth}{!}{%
\begin{tabular}{ll}
 \multicolumn{1}{c}{\textbf{Giảng viên hướng dẫn:}} & TS. Trần Vĩnh Đức \hspace{0.5cm} 
  \\[0.5cm]
